...
public class UserHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // Insert Into Table
        db.execSQL("insert into " + TABLE_NAME + " values(8529,'Rahul Garg', 'piyush@gmail.com','9985','8855640238', 6500)");
        db.execSQL("insert into " + TABLE_NAME + " values(4562,'Ritik Sharma', 'ritik@gmail.com','6582','9309565238', 10500)");
        db.execSQL("insert into " + TABLE_NAME + " values(9512,'Inder Chahar', 'gauri@gmail.com','2236','6254642205', 3500)");
        db.execSQL("insert into " + TABLE_NAME + " values(7853,'Sunno Devi', 'khushi@gmail.com','4522','9985021539', 2500)");
        db.execSQL("insert into " + TABLE_NAME + " values(7854,'Anurag Sharma', 'anurag@gmail.com','2656','9015641200', 9800)");
        db.execSQL("insert into " + TABLE_NAME + " values(2365,'Rohan Harman', 'rohit@gmail.com','5450','8292591201', 9900)");
        ...
        db.execSQL("insert into " + TABLE_NAME + " values(3698,'Prityusha Priyadarshi', 'yash@gmail.com','1207','8895640215', 4500)");
